export const words = {
  zh: {
    ...
    viewMode: '办公室视图', pixelView: '像素', orbitHint: '拖动旋转 · 滚轮缩放',
    ...
    open: '查看会话', selectHint: '点击人物查看状态与会话', fit: '全景', focus: '聚焦', dismiss: '关闭成员详情',
  ...
  en: {
    ...
    viewMode: 'Office view', pixelView: 'Pixel', orbitHint: 'Drag to orbit · Scroll to zoom',
    ...
    open: 'View conversation', selectHint: 'Select a character for status and conversation', fit: 'Fit', focus: 'Focus', dismiss: 'Dismiss member details',
